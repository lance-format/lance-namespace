...
```groovy
compile "org.lance:lance-namespace-apache-client:0.5.4"
```
...
- `target/lance-namespace-apache-client-0.5.4.jar`
- `target/lib/*.jar`
...
## Documentation for Models
 ...
 - [CommitTableOperationCreateTableVersion](docs/CommitTableOperationCreateTableVersion.md)
 - [CommitTableOperationDeclareTable](docs/CommitTableOperationDeclareTable.md)
 - [CommitTableOperationDeleteTableVersions](docs/CommitTableOperationDeleteTableVersions.md)
 - [CommitTableOperationDeregisterTable](docs/CommitTableOperationDeregisterTable.md)
 - [CommitTableResult](docs/CommitTableResult.md)
 - [CommitTableResultCreateTableVersion](docs/CommitTableResultCreateTableVersion.md)
 - [CommitTableResultDeclareTable](docs/CommitTableResultDeclareTable.md)
 - [CommitTableResultDeleteTableVersions](docs/CommitTableResultDeleteTableVersions.md)
 - [CommitTableResultDeregisterTable](docs/CommitTableResultDeregisterTable.md)
