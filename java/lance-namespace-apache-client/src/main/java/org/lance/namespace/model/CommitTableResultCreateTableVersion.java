...
@JsonPropertyOrder({
  CommitTableResultCreateTableVersion.JSON_PROPERTY_TYPE,
  CommitTableResultCreateTableVersion.JSON_PROPERTY_VERSION
})
@javax.annotation.Generated(
    value = "org.openapitools.codegen.languages.JavaClientCodegen",
    comments = "Generator version: 7.12.0")
public class CommitTableResultCreateTableVersion {
  /** Gets or Sets type */
  ...
  public CommitTableResultCreateTableVersion type(@javax.annotation.Nonnull TypeEnum type) {
  ...
  public CommitTableResultCreateTableVersion version(
      @javax.annotation.Nonnull TableVersion version) {
