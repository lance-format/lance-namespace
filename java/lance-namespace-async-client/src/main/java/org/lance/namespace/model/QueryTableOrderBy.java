...
public class QueryTableOrderBy {
  ...
  /** Return true if this QueryTableOrderBy object is equal to o. */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getColumnName() != null) {
      joiner.add(
          String.format(
              "%scolumn_name%s=%s",
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getColumnName()))));
    }
    ...
    if (getAscending() != null) {
      joiner.add(
          String.format(
              "%sascending%s=%s",
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAscending()))));
    }
    ...
    if (getNullsFirst() != null) {
      joiner.add(
          String.format(
              "%snulls_first%s=%s",
              prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNullsFirst()))));
    }
