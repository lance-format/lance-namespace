...
| [**batchCommitTables**](TransactionApi.md#batchCommitTables) | **POST** /v1/table/batch-commit | Atomically commit a batch of mixed table operations |
| [**batchCommitTablesWithHttpInfo**](TransactionApi.md#batchCommitTablesWithHttpInfo) | **POST** /v1/table/batch-commit | Atomically commit a batch of mixed table operations |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling TransactionApi#batchCommitTables");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
