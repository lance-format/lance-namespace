...
pub async fn analyze_table_query_plan(
    ...
    delimiter: Option<&str>,
) -> Result<String, Error<AnalyzeTableQueryPlanError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn batch_delete_table_versions(
    configuration: &configuration::Configuration,
    id: &str,
    batch_delete_table_versions_request: models::BatchDeleteTableVersionsRequest,
    delimiter: Option<&str>,
) -> Result<models::BatchDeleteTableVersionsResponse, Error<BatchDeleteTableVersionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn create_table_scalar_index(
    configuration: &configuration::Configuration,
    id: &str,
    create_table_index_request: models::CreateTableIndexRequest,
    delimiter: Option<&str>,
) -> Result<models::CreateTableScalarIndexResponse, Error<CreateTableScalarIndexError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_create_table_index_request = create_table_index_request;
    let p_delimiter = delimiter;
...
pub async fn create_table_tag(
    ...
    delimiter: Option<&str>,
) -> Result<models::CreateTableTagResponse, Error<CreateTableTagError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn create_table_version(
    configuration: &configuration::Configuration,
    id: &str,
    create_table_version_request: models::CreateTableVersionRequest,
    delimiter: Option<&str>,
) -> Result<models::CreateTableVersionResponse, Error<CreateTableVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn declare_table(
    configuration: &configuration::Configuration,
    id: &str,
    declare_table_request: models::DeclareTableRequest,
    delimiter: Option<&str>,
) -> Result<models::DeclareTableResponse, Error<DeclareTableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn delete_table_tag(
    ...
    delimiter: Option<&str>,
) -> Result<models::DeleteTableTagResponse, Error<DeleteTableTagError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn describe_table_version(
    ...
    id: &str,
    version: i64,
    describe_table_version_request: models::DescribeTableVersionRequest,
    delimiter: Option<&str>,
) -> Result<models::DescribeTableVersionResponse, Error<DescribeTableVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn explain_table_query_plan(
    ...
    delimiter: Option<&str>,
) -> Result<String, Error<ExplainTableQueryPlanError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn list_all_tables(
    ...
    limit: Option<i32>,
) -> Result<models::ListTablesResponse, Error<ListAllTablesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_delimiter = delimiter;
...
pub async fn rename_table(
    ...
    delimiter: Option<&str>,
) -> Result<models::RenameTableResponse, Error<RenameTableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn update_table_schema_metadata(
    ...
    delimiter: Option<&str>,
) -> Result<std::collections::HashMap<String, String>, Error<UpdateTableSchemaMetadataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn update_table_tag(
    ...
    delimiter: Option<&str>,
) -> Result<models::UpdateTableTagResponse, Error<UpdateTableTagError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
