...
pub mod commit_table_operation_create_table_version;
pub use self::commit_table_operation_create_table_version::CommitTableOperationCreateTableVersion;
pub mod commit_table_operation_declare_table;
pub use self::commit_table_operation_declare_table::CommitTableOperationDeclareTable;
pub mod commit_table_operation_delete_table_versions;
pub use self::commit_table_operation_delete_table_versions::CommitTableOperationDeleteTableVersions;
pub mod commit_table_operation_deregister_table;
pub use self::commit_table_operation_deregister_table::CommitTableOperationDeregisterTable;
pub mod commit_table_result;
pub use self::commit_table_result::CommitTableResult;
pub mod commit_table_result_create_table_version;
pub use self::commit_table_result_create_table_version::CommitTableResultCreateTableVersion;
pub mod commit_table_result_declare_table;
pub use self::commit_table_result_declare_table::CommitTableResultDeclareTable;
pub mod commit_table_result_delete_table_versions;
pub use self::commit_table_result_delete_table_versions::CommitTableResultDeleteTableVersions;
pub mod commit_table_result_deregister_table;
pub use self::commit_table_result_deregister_table::CommitTableResultDeregisterTable;
