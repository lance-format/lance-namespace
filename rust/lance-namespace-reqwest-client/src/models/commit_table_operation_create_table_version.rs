...
/// CommitTableOperationCreateTableVersion : Create a new version entry for a table.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CommitTableOperationCreateTableVersion {
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl CommitTableOperationCreateTableVersion {
    /// Create a new version entry for a table.
    pub fn new(r#type: Type, id: Vec<String>, version: i64, manifest_path: String) -> CommitTableOperationCreateTableVersion {
