...
class MatchQuery(BaseModel):
    ...
    operator: Optional[StrictStr] = Field(default=None, description="The operator to use for combining terms. This can be either `And` or `Or`, it's 'Or' by default. - `And`: All terms must match. - `Or`: At least one term must match.")
