...
class CommitTableOperationCreateTableVersion(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "id", "version", "manifest_path", "manifest_size", "e_tag", "metadata", "naming_scheme"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['create_table_version']):
            raise ValueError("must be one of enum values ('create_table_version')")
        return value
