...
class CommitTableOperationDeleteTableVersions(BaseModel):
    """
    Delete version ranges from a table.
    """ # noqa: E501
    type: StrictStr
    id: List[StrictStr] = Field(description="The table identifier")
    ranges: List[VersionRange] = Field(description="List of version ranges to delete")
    __properties: ClassVar[List[str]] = ["type", "id", "ranges"]
