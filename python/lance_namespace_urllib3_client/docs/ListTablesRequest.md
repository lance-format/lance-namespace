...
**list_declared** | **bool** | When true, includes tables that have been declared in the namespace but not yet created on storage. Default is false.  | [optional] [default to False]
