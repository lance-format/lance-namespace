# CommitTableOperationCreateTableVersion
...
json = "{}"
# create an instance of CommitTableOperationCreateTableVersion from a JSON string
commit_table_operation_create_table_version_instance = CommitTableOperationCreateTableVersion.from_json(json)
# print the JSON string representation of the object
print(CommitTableOperationCreateTableVersion.to_json())

# convert the object into a dict
commit_table_operation_create_table_version_dict = commit_table_operation_create_table_version_instance.to_dict()
# create an instance of CommitTableOperationCreateTableVersion from a dict
commit_table_operation_create_table_version_from_dict = CommitTableOperationCreateTableVersion.from_dict(commit_table_operation_create_table_version_dict)
```
