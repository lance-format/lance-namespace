...
class TestPartitionTransform(unittest.TestCase):
    """PartitionTransform unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartitionTransform:
        """Test PartitionTransform
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartitionTransform`
        """
        model = PartitionTransform()
        if include_optional:
    ...
    def testPartitionTransform(self):
        """Test PartitionTransform"""
