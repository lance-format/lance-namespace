...
class TestAlterColumnsEntry(unittest.TestCase):
    """AlterColumnsEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlterColumnsEntry:
        """Test AlterColumnsEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlterColumnsEntry`
        """
    ...
    def testAlterColumnsEntry(self):
        """Test AlterColumnsEntry"""
